...
Kuvaus:
Reseptisovellus on full-stack sovellus, jossa käyttäjä pystyy selaamaan sivustolla olevia reseptejä. 
...
Teknologia:
- kieli: JavaScript
- frontend: React, React Router, CSS, Bootstrap Cloudinary
